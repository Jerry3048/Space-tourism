...
function Nav() {
  ...
  return (
    <nav className= "flex justify-between items-center  text-white lg:ml-[100px] ml-[40px] lg:pt-[60px] pr-10 md:pr-0">
        ...
        {menuOpen && (
        <div className={`fixed top-0 right-0 z-50 flex flex-col items-start w-[70%] md:hidden h-full backdrop-blur-md bg-gray-500/20 p-8  space-y-[30%] transition-transform duration-300 ease-in-out transform ${menuOpen ? 'translate-x-0' : 'translate-x-[-100%]'}`}>
          <img
